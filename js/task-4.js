...
users
    ...
    .map(user => user.balance)                    // Отримуємо масив балансів користувачів
    .reduce((total, balance) => total + balance, 0); // Підсумовуємо всі баланси

// Тест для перевірки коректності роботи функції
const clients = [
